		...
		try {
			...
			for (int i = 0; i < pedidos.getLength(); i++) {
				...
				if (pedid.getNodeType() == Node.ELEMENT_NODE) {
					...
					System.out.println("Numero cliente: " + getNodo("numero-cliente", pedido));
					System.out.println("Numero de pedido: " + getNodo("numero-pedido", pedido));
					System.out.println("Fecha: " + getNodo("fecha", pedido));
