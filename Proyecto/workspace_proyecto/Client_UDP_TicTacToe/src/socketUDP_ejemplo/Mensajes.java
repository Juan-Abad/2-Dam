...
public class Mensajes {
	...
	public static class MensajeReiniciarVotacion {
		String tipo = "Reiniciar juego votacion";
	}
	
	public static class MensajeCancelarReinicio {
		String tipo = "Cancelar reinicio";
	}
	
	public static class MensajeReiniciar {
		String tipo = "Reiniciar juego";
	}
}
