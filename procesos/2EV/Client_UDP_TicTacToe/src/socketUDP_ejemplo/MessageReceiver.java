...
public class MessageReceiver implements Runnable {
	...
	public void run() {
		Dialog_playAgain dialogo_partida_Terminada = null;
		Gson gson = new Gson();
		while (true) {
			try {
				...
				case "Ganador":
					frame.pauseJuego();
					dialogo_partida_Terminada = new Dialog_playAgain(frame);
					dialogo_partida_Terminada.getLblNewLabel().setText("¡Has ganado!");
					dialogo_partida_Terminada.setVisible(true);
					break;
				case "Perdedor":
					frame.pauseJuego();
					dialogo_partida_Terminada = new Dialog_playAgain(frame);
					dialogo_partida_Terminada.getLblNewLabel().setText("¡Has perdido!");
					dialogo_partida_Terminada.setVisible(true);
					break;
				case "Empate":
					frame.pauseJuego();
					dialogo_partida_Terminada = new Dialog_playAgain(frame);
					dialogo_partida_Terminada.getLblNewLabel().setText("¡Habeis empatado!");
					dialogo_partida_Terminada.setVisible(true);
					break;
				case "Reiniciar juego":
					frame.resetGame();
					dialogo_partida_Terminada.setVisible(false);
					dialogo_partida_Terminada.getOkButton().setBackground(new Color(240,240,240));
					break;
				default:
					break;
				}
