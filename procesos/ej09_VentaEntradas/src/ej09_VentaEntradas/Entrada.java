...
public class Entrada {//Clase Entrada
	private static ArrayList<Entrada> listaEntradas = new ArrayList<Entrada>(); //Esta es una lista que guarda las(en este caso) 200 entradas a vender, es estatico para que la lista de las entradas pueda ser accedida deste el resto de entradas.
    ...
    public static void inicializarEntradas(int numeroMaxEntradas) {//Metodo estatico que permite inicializar las entradas, a este metodo se le indica por parametros cuantras entradas van a estar disponibles para venderse. Y ejecuta un codigo el cual en funcion de ese parametro crea un numero de entradas.
