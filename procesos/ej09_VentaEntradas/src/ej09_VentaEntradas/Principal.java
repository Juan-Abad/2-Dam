...
public class Principal {
	...
	public static void main(String[] args) {//main
		...
		Entrada entrada = new Entrada();//creamos una entrada para inicializarlas en ese metodo estatico que tienen la entradas
		entrada.inicializarEntradas(numMaxEntradas);//se inicializan las entradas, pasando el numero de entradas que se pondran en venta
